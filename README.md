...
|       |         |поисковая строка                     |JS. при совпадении имён отрисовывать карточки под хедером. все карточки загружаются из mockAPI | +- доработать сброс отображаемых товаров после изменения критерия поиска
