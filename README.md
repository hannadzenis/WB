...
|       |         |поисковая строка                     |JS. результаты поиска отображать в блоке hits, путём сортировки по совпадению имён | +- доработать сброс отображаемых товаров после изменения критерия поиска
